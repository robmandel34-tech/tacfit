    ...
    <div className="min-h-screen backdrop-blur-md bg-white/5">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-6">
          ...
          <p className="text-gray-400">Complete guide to Muster's tactical operations and competition mechanics</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-gray-800/50 border-gray-700">
            ...
            <CardContent className="text-gray-300 space-y-4">
              <p>
                Muster competitions are structured fitness challenges designed to promote teamwork, 
          ...
          <Card className="bg-gray-800/50 border-gray-700">
            ...
            <CardContent className="text-gray-300 space-y-4">
              <div className="bg-military-green/20 border border-military-green/40 p-4 rounded-lg">
                <h4 className="font-semibold text-military-green mb-1">Muster is completely free right now!</h4>
                <p className="text-sm">
