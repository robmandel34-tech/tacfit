          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm">
                All competitions on Main Link are <strong className="text-white">currently free</strong> to enter. 
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-gray-800/50 border-gray-700">
            ...
            <CardContent className="text-gray-300 space-y-4">
              <p>
                Tactical points are Main Link's currency system that rewards your fitness activities, 
              ...
              <div className="bg-military-green/10 border border-military-green/30 p-4 rounded-lg">
                ...
                <ul className="space-y-1 text-sm">
                  ...
                  <li>• <strong>Social Status:</strong> Display your dedication to the Main Link community</li>
                  <li>• <strong>Exclusive Rewards:</strong> Use points to earn slick Main Link swag</li>
                </ul>
              </div>
            </CardContent>
          </Card>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-900/20 border border-blue-600/30 p-4 rounded-lg">
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      Earned when someone joins Main Link using your phone invitation link
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Card className="bg-gray-800/50 border-gray-700">
            ...
            <CardContent className="space-y-6">
              <p className="text-gray-300">
                ...
                demonstrate your commitment to the Main Link community.
              </p>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-gray-700/50 p-3 rounded-lg">
                      ...
                      <p className="text-xs text-gray-400">
                        Higher point totals demonstrate your commitment to the Main Link community 
                    ...
                    <div className="bg-gray-700/50 p-3 rounded-lg">
                      ...
                      <p className="text-xs text-gray-400">
                        ...
                        in the Main Link community, earning respect and bonus rewards.
                      </p>
                    </div>
                    <div className="bg-gray-700/50 p-3 rounded-lg">
                      <h5 className="font-medium text-military-green mb-2">Invite Buddies</h5>
                      <p className="text-xs text-gray-400">
                        Use phone invitations to bring buddies to Main Link. Each successful 
