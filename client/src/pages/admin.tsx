...
export default function AdminPage() {
  ...
  const handleEdit = (competition: Competition) => {
    ...
    setCompetitionForm({
      ...
      joinStartDate: competition.joinStartDate ? new Date(competition.joinStartDate).toISOString().split('T')[0] : '',
      joinEndDate: competition.joinEndDate ? new Date(competition.joinEndDate).toISOString().split('T')[0] : '',
                        ...
                        <>
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              className="bg-tactical-gray-lighter border-tactical-gray text-white"
                            />
                            <p className="text-xs text-gray-500 mt-1">Users must write at least this many words (minimum: 10, maximum: 100, default: 50)</p>
                          </div>
                        </>
                      )}
                    </div>
