    ...
    <div className="min-h-screen bg-tactical-gray">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-6">
          ...
          <p className="text-gray-400">Complete guide to navigating the Main Link platform efficiently</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-gray-800/50 border-gray-700">
            ...
            <CardContent className="text-gray-300 space-y-4">
              <p>
                Main Link uses a dual navigation system designed for both desktop and mobile users. 
