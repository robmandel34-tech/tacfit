...
export function OnboardingWalkthrough({ isOpen, onClose, onComplete, onSaveSurvey, initialArchetype, initialActivities }: OnboardingWalkthroughProps) {
  ...
  const steps: OnboardingStep[] = [
        ...
        <div className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-gray-300">
              Muster is a team-based fitness competition platform where you'll join teams, 
    ...
    },
    {
      ...
      description: 'How competitions work in Muster',
      icon: <Target className="h-6 w-6" />,
      content: (
        <div className="space-y-4">
      ...
      content: (
        <div className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-gray-300">
              Muster supports free speech and encourages light-hearted banter between teams. 
          ...
          <div className="bg-blue-900/20 border border-blue-600/30 p-3 rounded-lg">
            <p className="text-sm text-blue-200">
              <strong>Remember:</strong> Muster is about building a supportive fitness community. 
