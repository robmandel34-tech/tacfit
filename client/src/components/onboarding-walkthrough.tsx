        ...
        <div className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-gray-300">
              TacFit is a team-based fitness competition platform where you'll join squads, 
        ...
        <div className="space-y-4">
          ...
          <div className="bg-military-green/20 border border-military-green/30 p-3 rounded-lg">
            ...
            <div className="space-y-1 text-sm">
              <p className="text-gray-300">• Base activity: <strong className="text-white">20 points</strong></p>
              <p className="text-gray-300">• With photo evidence: <strong className="text-white">20 points</strong></p>
