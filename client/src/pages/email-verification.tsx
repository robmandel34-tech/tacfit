      ...
      try {
        ...
        if (response.ok && (data.verified || data.alreadyVerified)) {
          ...
          toast({
            ...
            description: "Open the Muster Up app and sign in to get started.",
          });
        } else {
      ...
      <Card className="w-full max-w-md card-modern">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-body text-lg">
            {isVerifying 
              ...
              : isVerified 
                ? "Your email is verified. Open the Muster Up app and sign in to get started."
        ...
        {isVerified && (
          <CardContent className="space-y-4">
            ...
            >
              Open the Muster Up App
            </Button>
            <p className="text-muted text-center text-sm">
              On your iPhone, tap the button above to jump back into the app and sign in. If nothing happens, open the Muster Up app from your home screen.
            </p>
            <Button
              variant="outline"
