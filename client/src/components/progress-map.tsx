    ...
    <div className="w-full">
      ...
      <div className="relative">
        <div className="flex justify-center mb-0">
          <div className="bg-tactical-gray-light border-tactical-gray border-t border-l border-r rounded-t-2xl px-6 py-3 shadow-lg" style={{ 
        ...
        <div className="w-full bg-tactical-gray-light border-tactical-gray rounded-2xl shadow-2xl">
          <div className="p-6">
                ...
                <div className="absolute inset-0 rounded-xl overflow-hidden">
                  ...
                  <div 
                    ...
                    style={{
                      ...
                      filter: 'brightness(1.55) contrast(1.2) saturate(1.1)'
                    }}
                  />
