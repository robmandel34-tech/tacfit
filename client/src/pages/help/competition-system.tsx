    ...
    <div className="min-h-screen backdrop-blur-md bg-white/5">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-6">
          ...
          <p className="text-gray-400">Complete guide to Muster Up's tactical operations and competition mechanics</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-gray-800/50 border-gray-700">
            ...
            <CardContent className="text-gray-300 space-y-4">
              <p>
                Muster Up competitions are structured fitness challenges designed to promote teamwork, 
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-gray-700/50 rounded-lg">
                      <span className="text-sm">Effort-based (per minute or per rep, x2)</span>
                      <span className="font-semibold text-military-green">2 pts each</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-gray-700/50 rounded-lg">
                      <span className="text-sm">Evidence Bonus (photo / video)</span>
                      <span className="font-semibold text-military-green">+15 / +30</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-gray-700/50 rounded-lg">
          ...
          <Card className="bg-gray-800/50 border-gray-700">
            ...
            <CardContent className="text-gray-300 space-y-4">
              <div className="bg-military-green/20 border border-military-green/40 p-4 rounded-lg">
                <h4 className="font-semibold text-military-green mb-1">Muster Up is completely free right now!</h4>
                <p className="text-sm">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-1">
                          Earn <span className="text-military-green font-semibold">2 points per minute or per rep</span> (a 20 minute run = 40 points), plus 
                          <span className="text-military-green font-semibold"> +15 points</span> with a photo or <span className="text-military-green font-semibold">+30 points</span> with video evidence
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start">
