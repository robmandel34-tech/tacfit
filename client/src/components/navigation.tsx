        ...
        <div className="flex items-center justify-between min-w-0">
          <div className="flex items-center space-x-3 md:space-x-6 min-w-0 flex-shrink">
            <div className="flex items-center space-x-3 flex-shrink-0">
              ...
              />
              <span className="text-2xl font-bold text-heading tracking-tight">Muster Up</span>
            </div>
            ...
            <div className="relative">
              ...
              >
                <div className="relative">
                  ...
                  {hasNotifications && (
                    <div className="absolute top-0 left-0 bg-combat-orange rounded-full w-3 h-3"></div>
                  )}
                </div>
